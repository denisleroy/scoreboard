...
1. A CSV (Comma-Separated Values) file that provides data for the scoreboard. Each line has a timestamp in seconds followed by the updated values of other parameters (such as the game scores or any other piece of data that changes over the course of the movie).
